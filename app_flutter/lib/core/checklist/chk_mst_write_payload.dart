...
class ChkMstWritePayload {
  ...
  ChkMstWritePayload._(this._map);

  final Map<String, dynamic> _map;

  Map<String, dynamic> toRequestBody() => Map<String, dynamic>.from(_map);

  factory ChkMstWritePayload.fromMap(Map<String, dynamic> map) =>
      ChkMstWritePayload._(Map<String, dynamic>.from(map));
}
