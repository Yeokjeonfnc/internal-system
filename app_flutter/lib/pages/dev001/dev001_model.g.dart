...
Partner _$PartnerFromJson(Map<String, dynamic> json) => Partner(
  ...
  pZipCd: _stringAny(_readPartnerZip(json, 'pZipCd')),
  pAddress: _stringAny(_readPartnerAddr(json, 'pAddress')),
  pAddressDetail: _stringAny(_readPartnerAddrDetail(json, 'pAddressDetail')),
  evaluationStatus:
      $enumDecodeNullable(
  ...
  pRegion: _stringAny(_readPartnerRegion(json, 'pRegion')),
