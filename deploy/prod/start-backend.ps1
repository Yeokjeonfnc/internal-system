...
if (-not (Test-Path -LiteralPath $envFile)) {
    throw "Missing backend.env. Copy backend.env.example to backend.env and set DB_PASSWORD."
}
...
Write-Host "[OK] Production backend started. PID=$($process.Id), DB=$env:DB_NAME, PORT=$env:BACKEND_PORT"
